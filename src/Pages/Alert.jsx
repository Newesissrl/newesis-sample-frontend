...
const ToastMsg = ({ msg, locale }) => {
  return (
    <>
      <h2 className="text-xl font-bold pt-2 pb-4">{ReactHtmlParser(msg.title[locale] || msg.title.en || msg.title.it || "Sorry, missing locale and default language title",true,)}</h2>
